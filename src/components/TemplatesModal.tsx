...
export const TemplatesModal: React.FC<TemplatesModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-150">
      <div className="w-full max-w-2xl bg-white/95 backdrop-blur-2xl border border-zinc-200/80 rounded-3xl p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        <div className="flex items-center justify-between pb-4 border-b border-zinc-100 mb-5">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-zinc-100 flex items-center justify-center text-zinc-900 border border-zinc-200/60">
              <Calendar className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-[17px] font-semibold text-zinc-900">University Timetable Templates</h3>
        ...
        <div className="space-y-3 max-h-[60vh] overflow-y-auto pr-1">
          {templates.map((tpl, idx) => (
            <div
              key={idx}
              className="p-4 rounded-2xl border border-zinc-200/80 hover:border-zinc-400 bg-white hover:bg-zinc-50/60 transition-all duration-150 flex items-center justify-between group"
            >
              <div className="space-y-1 pr-4">
                <div className="flex items-center gap-2">
                  <h4 className="text-[14.5px] font-semibold text-zinc-900">{tpl.name}</h4>
                  <span className="px-2 py-0.5 text-[10.5px] font-medium bg-zinc-100 text-zinc-700 rounded-md">
                    {tpl.shift}
                  </span>
                </div>
                <p className="text-[12px] text-zinc-500">{tpl.description}</p>
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-black hover:bg-zinc-800 text-white text-[12.5px] font-medium transition-transform active:scale-95 flex items-center gap-1.5 shrink-0 shadow-xs"
              >
        ...
        <div className="pt-4 mt-4 border-t border-zinc-100 flex items-center justify-between text-[12px] text-zinc-500">
